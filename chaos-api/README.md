...
In this sample, we use LocalStack Chaos API to cause controlled outages in the DynamoDB service to study the resiliency of the architecture and improve fault tolerance.
